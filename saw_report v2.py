...
Use one of the following 2 arguments to build the specified components and analyze the SA warnings.
        ...
        Eg. ./saw_report -comp infra/port_manager/fc-pm -branch iplus_dev
            ./saw_report -comp infra/port_manager/fc-pm -branch davis
            ./saw_report -comp_filelist file.txt -branch skywalker 
            ''')
        ...
        for module in module_list:
            if module in N7KMDS_lineup:
                ...
                exists = " does not exist in any of the component lineup files. Coverity will not run for this conmponent."

            if exists in ['', 'N7KMDS', 'COMMON']:
                module_map[module] = exists
                print('{0} exists in {1}/.ACMEROOT/ws.lu'.format(module, exists))
            else:
