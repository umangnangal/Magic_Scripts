...
def warning_analyze_print(name = ''):
    ...
    for file in glob.glob('*'):
        ...
        for line in f:
            line = line.strip()
            if 'error:' in line or 'warning:' in line and '.mk' not in line and '.c' in line and '.cli' not in line:
        ...
        for line in f:
            line = line.strip()
            if 'error:' in line or 'warning:' in line and '.mk' not in line and '.c' in line and '.cli' not in line and '.cmd' not in line:
                flag=0
